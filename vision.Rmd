...
<p style="text-align: justify;">
Training of scientist in how to manage their data effectively, and how to make their science reproducible, is a first step to improve open science practices of the community as a whole. These courses introduce the usage of metadata and standards for data management as well as practical and digital solutions to improve practices for secure storage and maintenance of data [@Briney2015].
</p>

### Institutes

<p style="text-align: justify;">
Providing support for open science solutions in the lab. This is achieved by evaluating existing on-premise laboratory and data management infrastructures and advice on how to implement, or upgrade to, a rigid, centralized structure than can accommodate automated data ingestion from various devices and/or manual entries. 
</p>

### Universally

<p style="text-align: justify;">
In addition, through active development of new solutions for data retrieval, harmonization and management tools as well as transparent, customizable and shareable workflows that can replace vendor supplied software for data processing, analysing and diagnostics. These solutions will be developed based upon solid research of existing practices and workflow routines, and by identifying common bottlenecks that prevent data from being FAIR, and workflows from being reproducible.
</p>
